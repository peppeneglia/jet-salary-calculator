    ...
    schede: [
      {
        ...
        note: [
          ...
          { it: 'Sul testo dell’art. 50 non risultano né soglie di esenzione né detrazioni regionali. Va però detto che l’argomento dal silenzio ha già fallito una volta sullo stesso articolo, che non conosce nemmeno gli scaglioni: non è una prova di inesistenza, è una prova di assenza in quel testo. E i dati ministeriali mostrano detrazioni regionali che esistono.', en: 'On the text of art. 50 there is neither an exemption threshold nor any regional credit. It has to be said, though, that the argument from silence has already failed once on this same article, which does not know about brackets either: it is not proof of non-existence, it is proof of absence from that text. And the ministerial data show regional credits that do exist.' },
        ],
      },
      {
